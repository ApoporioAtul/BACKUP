...
public class CardDetails: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if cardNumber != nil {
			dictionary.updateValue(cardNumber!, forKey: kDetailsCardNumberKey)
		}
		if cardId != nil {
			dictionary.updateValue(cardId!, forKey: kDetailsCardIdKey)
		}
		if cardType != nil {
			dictionary.updateValue(cardType!, forKey: kDetailsCardTypeKey)
		}

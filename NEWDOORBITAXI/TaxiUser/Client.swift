    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if paypalSdkVersion != nil {
			dictionary.updateValue(paypalSdkVersion!, forKey: kClientPaypalSdkVersionKey)
		}
		if platform != nil {
			dictionary.updateValue(platform!, forKey: kClientPlatformKey)
		}
		if environment != nil {
			dictionary.updateValue(environment!, forKey: kClientEnvironmentKey)
		}
		if productName != nil {
			dictionary.updateValue(productName!, forKey: kClientProductNameKey)
		}

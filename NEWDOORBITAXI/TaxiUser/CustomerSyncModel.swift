...
public class CustomerSyncModel: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kCustomerSyncModelDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kCustomerSyncModelResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kCustomerSyncModelMsgKey)
		}

...
public class PayCardModel: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if paymentId != nil {
			dictionary.updateValue(paymentId!, forKey: kPayCardModelPaymentIdKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kPayCardModelResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kPayCardModelMsgKey)
		}

    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if paymentOptionNameArabic != nil {
			dictionary.updateValue(paymentOptionNameArabic!, forKey: kMsgPaymentOptionNameArabicKey)
		}
		if paymentOptionNameFrench != nil {
			dictionary.updateValue(paymentOptionNameFrench!, forKey: kMsgPaymentOptionNameFrenchKey)
		}
		if paymentOptionName != nil {
			dictionary.updateValue(paymentOptionName!, forKey: kMsgPaymentOptionNameKey)
		}
		if status != nil {

...
public class SignupLoginResponse: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if value != nil {
			dictionary.updateValue(value!, forKey: kSignupLoginResponseValueKey)
		}
		if message != nil {
			dictionary.updateValue(message!, forKey: kSignupLoginResponseMessageKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kSignupLoginResponseResultKey)
		}
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kSignupLoginResponseDetailsKey)
		}

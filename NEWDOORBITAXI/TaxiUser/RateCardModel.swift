...
public class RateCardModel: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kRateCardModelDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kRateCardModelResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kRateCardModelMsgKey)
		}

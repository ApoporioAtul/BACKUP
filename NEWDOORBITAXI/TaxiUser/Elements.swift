...
public class Elements: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if status != nil {
			dictionary.updateValue(status!, forKey: kElementsStatusKey)
		}
		if distance != nil {
			dictionary.updateValue(distance!.dictionaryRepresentation(), forKey: kElementsDistanceKey)
		}
		if duration != nil {
			dictionary.updateValue(duration!.dictionaryRepresentation(), forKey: kElementsDurationKey)
		}

    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if paymentPlatform != nil {
			dictionary.updateValue(paymentPlatform!, forKey: kDetailsPaymentPlatformKey)
		}
		if paymentId != nil {
			dictionary.updateValue(paymentId!, forKey: kDetailsPaymentIdKey)
		}
		if paymentDateTime != nil {
			dictionary.updateValue(paymentDateTime!, forKey: kDetailsPaymentDateTimeKey)
		}
		if paymentMethod != nil {
			dictionary.updateValue(paymentMethod!, forKey: kDetailsPaymentMethodKey)
		}
		if userId != nil {
			dictionary.updateValue(userId!, forKey: kDetailsUserIdKey)
		}
		if paymentAmount != nil {
			dictionary.updateValue(paymentAmount!, forKey: kDetailsPaymentAmountKey)
		}
		if orderId != nil {
			dictionary.updateValue(orderId!, forKey: kDetailsOrderIdKey)
		}

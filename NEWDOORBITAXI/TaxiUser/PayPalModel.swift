...
public class PayPalModel: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if response != nil {
			dictionary.updateValue(response!.dictionaryRepresentation(), forKey: kPayPalModelResponseKey)
		}
		if responseType != nil {
			dictionary.updateValue(responseType!, forKey: kPayPalModelResponseTypeKey)
		}
		if client != nil {
			dictionary.updateValue(client!.dictionaryRepresentation(), forKey: kPayPalModelClientKey)
		}

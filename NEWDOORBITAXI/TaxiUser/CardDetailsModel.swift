...
public class CardDetailsModel: NSObject {
    ...
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        if details?.count > 0 {
            ...
            dictionary.updateValue(temp, forKey: kCardDetailsModelDetailsKey)
        }
        if result != nil {
            dictionary.updateValue(result!, forKey: kCardDetailsModelResultKey)
        }
        if msg != nil {
            dictionary.updateValue(msg!, forKey: kCardDetailsModelMsgKey)
        }
  ...
  /*  // MARK: Declaration for string constants to be used to decode and also serialize.
    ...
    */
    public init(json: JSON) {
		details = CardDetails(json: json[kCardDetailsModelDetailsKey])
		result = json[kCardDetailsModelResultKey].int
		msg = json[kCardDetailsModelMsgKey].string
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        var dictionary: [String : AnyObject ] = [ : ]
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kCardDetailsModelDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kCardDetailsModelResultKey)
		}

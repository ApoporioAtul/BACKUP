...
public class DriverInfo: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kDriverInfoDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kDriverInfoResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kDriverInfoMsgKey)
		}

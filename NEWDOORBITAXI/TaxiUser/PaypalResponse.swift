...
public class PaypalResponse: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if intent != nil {
			dictionary.updateValue(intent!, forKey: kResponseIntentKey)
		}
		if createTime != nil {
			dictionary.updateValue(createTime!, forKey: kResponseCreateTimeKey)
		}
		if internalIdentifier != nil {
			dictionary.updateValue(internalIdentifier!, forKey: kResponseInternalIdentifierKey)
		}
		if state != nil {
			dictionary.updateValue(state!, forKey: kResponseStateKey)
		}

...
public class MsgDocument: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if merchantId != nil {
			dictionary.updateValue(merchantId!, forKey: kMsgMerchantIdKey)
		}
		if documentName != nil {
			dictionary.updateValue(documentName!, forKey: kMsgDocumentNameKey)
		}
		if status != nil {
			dictionary.updateValue(status!, forKey: kMsgStatusKey)
		}
		if documentTypeId != nil {
			dictionary.updateValue(documentTypeId!, forKey: kMsgDocumentTypeIdKey)
		}

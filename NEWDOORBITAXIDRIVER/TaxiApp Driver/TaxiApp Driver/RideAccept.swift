...
public class RideAccept: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kRideAcceptDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kRideAcceptResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kRideAcceptMsgKey)
		}

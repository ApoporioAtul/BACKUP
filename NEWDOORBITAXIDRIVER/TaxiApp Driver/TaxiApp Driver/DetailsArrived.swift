...
public class DetailsArrived: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if totTime != nil {
			dictionary.updateValue(totTime!, forKey: kDetailsTotTimeKey)
		}
		if endLocation != nil {
		...
		if waitingTime != nil {
			dictionary.updateValue(waitingTime!, forKey: kDetailsWaitingTimeKey)
		}
		if arrivedTime != nil {
		...
		if endLong != nil {
			dictionary.updateValue(endLong!, forKey: kDetailsEndLongKey)
		}
		if endTime != nil {
			dictionary.updateValue(endTime!, forKey: kDetailsEndTimeKey)
		}
		if endLat != nil {
			dictionary.updateValue(endLat!, forKey: kDetailsEndLatKey)
		}
		if doneRideId != nil {

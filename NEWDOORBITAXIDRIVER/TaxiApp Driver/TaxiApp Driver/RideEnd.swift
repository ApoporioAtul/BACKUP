...
public class RideEnd: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kRideEndDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kRideEndResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kRideEndMsgKey)
		}

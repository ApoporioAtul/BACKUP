...
public class ViewRide: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kViewRideDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kViewRideResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kViewRideMsgKey)
		}

...
public class Arrived: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if details != nil {
			dictionary.updateValue(details!.dictionaryRepresentation(), forKey: kArrivedDetailsKey)
		}
		if result != nil {
			dictionary.updateValue(result!, forKey: kArrivedResultKey)
		}
		if msg != nil {
			dictionary.updateValue(msg!, forKey: kArrivedMsgKey)
		}

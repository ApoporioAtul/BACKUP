...
public class MsgReason: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if reasonType != nil {
			dictionary.updateValue(reasonType!, forKey: kMsgReasonTypeKey)
		}
		if status != nil {
			dictionary.updateValue(status!, forKey: kMsgStatusKey)
		}
		if reasonId != nil {
			dictionary.updateValue(reasonId!, forKey: kMsgReasonIdKey)
		}
		if reasonName != nil {
			dictionary.updateValue(reasonName!, forKey: kMsgReasonNameKey)
		}

...
public class CarType: NSObject {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if result != nil {
			dictionary.updateValue(result!, forKey: kCarTypeResultKey)
		}
		if msg?.count > 0 {
			var temp: [AnyObject] = []
			for item in msg! {
			...
			dictionary.updateValue(temp, forKey: kCarTypeMsgKey)
		}
